 ...
 */
#pragma once
#ifndef MAVLINK_HERONAI_H
#define MAVLINK_HERONAI_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_HERONAI.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_ENABLED_HERONAI
...
typedef enum MAV_FRAME
{
   ...
   MAV_FRAME_GLOBAL_UNKNOWN=30, /*  | */
   MAV_FRAME_LOCAL_UNKNOWN=31, /*  | */
   MAV_FRAME_BODY_ENU=32, /*  | */
   MAV_FRAME_ENUM_END=33, /*  | */
} MAV_FRAME;
#endif

/** @brief These values define the type of AI events that could occur during the test evaluation. */
#ifndef HAVE_ENUM_LOGGING_EVENT_TAGS
#define HAVE_ENUM_LOGGING_EVENT_TAGS
typedef enum LOGGING_EVENT_TAGS
{
   ...
   LOGGING_EVENT_TAGS_ENUM_END=7, /*  | */
} LOGGING_EVENT_TAGS;
#endif

/** @brief These values define the type of AI events that could occur during the test evaluation. */
#ifndef HAVE_ENUM_AI_PROCEDURAL_COMMANDS
#define HAVE_ENUM_AI_PROCEDURAL_COMMANDS
typedef enum AI_PROCEDURAL_COMMANDS
{
   ...
   AI_PROCEDURAL_COMMANDS_ENUM_END=4, /*  | */
} AI_PROCEDURAL_COMMANDS;
#endif

/** @brief These values create the termination criteria for an evaluation event. */
#ifndef HAVE_ENUM_AI_TERMINATION_CRITERIA
#define HAVE_ENUM_AI_TERMINATION_CRITERIA
typedef enum AI_TERMINATION_CRITERIA
{
   ...
   AI_TERMINATION_CRITERIA_ENUM_END=4, /*  | */
} AI_TERMINATION_CRITERIA;
#endif
...
#include "./mavlink_msg_vehicle_sync.h"
#include "./mavlink_msg_guided_target_stats.h"
#include "./mavlink_msg_ai_execute_procedural.h"
#include "./mavlink_msg_write_event_to_log.h"
#include "./mavlink_msg_set_surface_deflection_normalized.h"
