...
static void mavlink_test_ai_test_parameterization(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ai_test_parameterization_t packet1, packet2;
        ...
        packet1.blue_agent_type = packet_in.blue_agent_type;
    ...
    mavlink_msg_ai_test_parameterization_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_test_parameterization_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.field_file , packet1.file_one , packet1.file_two , packet1.tc_file , packet1.origin_lat , packet1.origin_lng , packet1.origin_alt , packet1.test_id , packet1.blue_agent_type , packet1.red_agent_type );
    mavlink_msg_ai_test_parameterization_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_test_parameterization_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.field_file , packet1.file_one , packet1.file_two , packet1.tc_file , packet1.origin_lat , packet1.origin_lng , packet1.origin_alt , packet1.test_id , packet1.blue_agent_type , packet1.red_agent_type );
    mavlink_msg_ai_test_parameterization_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ai_test_parameterization_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ai_test_parameterization_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.field_file , packet1.file_one , packet1.file_two , packet1.tc_file , packet1.origin_lat , packet1.origin_lng , packet1.origin_alt , packet1.test_id , packet1.blue_agent_type , packet1.red_agent_type );
    mavlink_msg_ai_test_parameterization_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
