...
enum class AI_EVENT_TYPE : uint8_t
{
    ...
    ABORTED_TEST=3, /* An event or situation had occured causing the test to be aborted. | */
    CEASING_TEST_EVALUATION=4, /* Testing conducted under the coordinating AI_NEW_TEST_EVALUATION tag is stopping. | */
};

//! AI_EVENT_TYPE ENUM_END
constexpr auto AI_EVENT_TYPE_ENUM_END = 5;
