/** @file
 *	@brief MAVLink comm testsuite protocol generated from mace_boundary.xml
...
TEST(mace_boundary, NEW_BOUNDARY_OBJECT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::NEW_BOUNDARY_OBJECT packet_in{};
    ...
    mavlink::mace_boundary::msg::NEW_BOUNDARY_OBJECT packet1{};
    mavlink::mace_boundary::msg::NEW_BOUNDARY_OBJECT packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, NEW_BOUNDARY_OBJECT)
{
...
TEST(mace_boundary, BOUNDARY_ACK)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::BOUNDARY_ACK packet_in{};
    packet_in.boundary_host_sysid = 5;
    packet_in.boundary_host_compid = 72;
    packet_in.boundary_identifier = 139;
    packet_in.boundary_result = 206;

    mavlink::mace_boundary::msg::BOUNDARY_ACK packet1{};
    mavlink::mace_boundary::msg::BOUNDARY_ACK packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, BOUNDARY_ACK)
{
    mavlink_message_t msg;
...
TEST(mace_boundary, BOUNDARY_REQUEST_LIST)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_LIST packet_in{};
    packet_in.boundary_host_sysid = 5;
    packet_in.boundary_host_compid = 72;
    packet_in.boundary_identifier = 139;

    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_LIST packet1{};
    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_LIST packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, BOUNDARY_REQUEST_LIST)
{
    mavlink_message_t msg;
...
TEST(mace_boundary, BOUNDARY_COUNT)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::BOUNDARY_COUNT packet_in{};
    packet_in.boundary_host_sysid = 139;
    packet_in.boundary_host_compid = 206;
    packet_in.boundary_identifier = 17;
    packet_in.count = 17235;

    mavlink::mace_boundary::msg::BOUNDARY_COUNT packet1{};
    mavlink::mace_boundary::msg::BOUNDARY_COUNT packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, BOUNDARY_COUNT)
{
    mavlink_message_t msg;
...
TEST(mace_boundary, BOUNDARY_REQUEST_ITEM)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_ITEM packet_in{};
    packet_in.boundary_host_sysid = 139;
    packet_in.boundary_host_compid = 206;
    packet_in.boundary_identifier = 17;
    packet_in.seq = 17235;

    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_ITEM packet1{};
    mavlink::mace_boundary::msg::BOUNDARY_REQUEST_ITEM packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, BOUNDARY_REQUEST_ITEM)
{
    mavlink_message_t msg;
...
TEST(mace_boundary, BOUNDARY_ITEM)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::mace_boundary::msg::BOUNDARY_ITEM packet_in{};
    ...
    mavlink::mace_boundary::msg::BOUNDARY_ITEM packet1{};
    mavlink::mace_boundary::msg::BOUNDARY_ITEM packet2{};
...
#ifdef TEST_INTEROP
TEST(mace_boundary_interop, BOUNDARY_ITEM)
{
    mavlink_message_t msg;
