...
#define MAVLINK_MSG_ID_MACE_MISSION_ACK 12504
...
#define MAVLINK_MSG_ID_MACE_MISSION_ACK_LEN 6
#define MAVLINK_MSG_ID_MACE_MISSION_ACK_MIN_LEN 3
#define MAVLINK_MSG_ID_12504_LEN 6
#define MAVLINK_MSG_ID_12504_MIN_LEN 3

#define MAVLINK_MSG_ID_MACE_MISSION_ACK_CRC 57
#define MAVLINK_MSG_ID_12504_CRC 57
...
#define MAVLINK_MESSAGE_INFO_MACE_MISSION_ACK { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mace_mission_ack_t, target_system) }, \
         ...
         { "mission_creator", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mace_mission_ack_t, mission_creator) }, \
         { "mission_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mace_mission_ack_t, mission_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MACE_MISSION_ACK { \
...
static inline uint16_t mavlink_msg_mace_mission_ack_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t type, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
...
{
    return mavlink_msg_mace_mission_ack_pack(system_id, component_id, msg, mace_mission_ack->target_system, mace_mission_ack->target_component, mace_mission_ack->type, mace_mission_ack->mission_type, mace_mission_ack->mission_creator, mace_mission_ack->mission_id);
}
...
{
    return mavlink_msg_mace_mission_ack_pack_chan(system_id, component_id, chan, msg, mace_mission_ack->target_system, mace_mission_ack->target_component, mace_mission_ack->type, mace_mission_ack->mission_type, mace_mission_ack->mission_creator, mace_mission_ack->mission_id);
}
...
static inline void mavlink_msg_mace_mission_ack_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t type, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_MISSION_ACK_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_mission_ack_send(chan, mace_mission_ack->target_system, mace_mission_ack->target_component, mace_mission_ack->type, mace_mission_ack->mission_type, mace_mission_ack->mission_creator, mace_mission_ack->mission_id);
#else
 ...
 */
static inline void mavlink_msg_mace_mission_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t type, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field mission_creator from mace_mission_ack message
 *
 * @return  Creator ID
 */
static inline uint8_t mavlink_msg_mace_mission_ack_get_mission_creator(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  4);
}

/**
 * @brief Get field mission_id from mace_mission_ack message
 *
 * @return  Mission ID
 */
static inline uint8_t mavlink_msg_mace_mission_ack_get_mission_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mace_mission_ack_decode(const mavlink_message_t* msg, mavlink_mace_mission_ack_t* mace_mission_ack)
{
    ...
    mace_mission_ack->mission_creator = mavlink_msg_mace_mission_ack_get_mission_creator(msg);
    mace_mission_ack->mission_id = mavlink_msg_mace_mission_ack_get_mission_id(msg);
#else
