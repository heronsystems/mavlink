...
#define MAVLINK_MSG_ID_MISSION_COUNT_LEN 7
#define MAVLINK_MSG_ID_MISSION_COUNT_MIN_LEN 4
#define MAVLINK_MSG_ID_44_LEN 7
...
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mission_count_t, target_system) }, \
         ...
         { "mission_creator", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mission_count_t, mission_creator) }, \
         { "mission_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_mission_count_t, mission_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
...
{
    return mavlink_msg_mission_count_pack(system_id, component_id, msg, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->mission_type, mission_count->mission_creator, mission_count->mission_id);
}
...
{
    return mavlink_msg_mission_count_pack_chan(system_id, component_id, chan, msg, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->mission_type, mission_count->mission_creator, mission_count->mission_id);
}
...
static inline void mavlink_msg_mission_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t count, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MISSION_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mission_count_send(chan, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->mission_type, mission_count->mission_creator, mission_count->mission_id);
#else
 ...
 */
static inline void mavlink_msg_mission_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t count, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Creator ID
 */
static inline uint8_t mavlink_msg_mission_count_get_mission_creator(const mavlink_message_t* msg)
{
 ...
 * @return  Mission ID
 */
static inline uint8_t mavlink_msg_mission_count_get_mission_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mission_count_decode(const mavlink_message_t* msg, mavlink_mission_count_t* mission_count)
{
    ...
    mission_count->mission_creator = mavlink_msg_mission_count_get_mission_creator(msg);
    mission_count->mission_id = mavlink_msg_mission_count_get_mission_id(msg);
#else
