...
#define MAVLINK_MSG_ID_MISSION_ACK_LEN 6
#define MAVLINK_MSG_ID_MISSION_ACK_MIN_LEN 3
#define MAVLINK_MSG_ID_47_LEN 6
...
#define MAVLINK_MESSAGE_INFO_MISSION_ACK { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mission_ack_t, target_system) }, \
         ...
         { "mission_creator", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mission_ack_t, mission_creator) }, \
         { "mission_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mission_ack_t, mission_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_ACK { \
...
{
    return mavlink_msg_mission_ack_pack(system_id, component_id, msg, mission_ack->target_system, mission_ack->target_component, mission_ack->type, mission_ack->mission_type, mission_ack->mission_creator, mission_ack->mission_id);
}
...
{
    return mavlink_msg_mission_ack_pack_chan(system_id, component_id, chan, msg, mission_ack->target_system, mission_ack->target_component, mission_ack->type, mission_ack->mission_type, mission_ack->mission_creator, mission_ack->mission_id);
}
...
static inline void mavlink_msg_mission_ack_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t type, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MISSION_ACK_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mission_ack_send(chan, mission_ack->target_system, mission_ack->target_component, mission_ack->type, mission_ack->mission_type, mission_ack->mission_creator, mission_ack->mission_id);
#else
 ...
 */
static inline void mavlink_msg_mission_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t type, uint8_t mission_type, uint8_t mission_creator, uint8_t mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  Creator ID
 */
static inline uint8_t mavlink_msg_mission_ack_get_mission_creator(const mavlink_message_t* msg)
{
 ...
 * @return  Mission ID
 */
static inline uint8_t mavlink_msg_mission_ack_get_mission_id(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mission_ack_decode(const mavlink_message_t* msg, mavlink_mission_ack_t* mission_ack)
{
    ...
    mission_ack->mission_creator = mavlink_msg_mission_ack_get_mission_creator(msg);
    mission_ack->mission_id = mavlink_msg_mission_ack_get_mission_id(msg);
#else
