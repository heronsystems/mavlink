...
#define MAVLINK_MSG_ID_MACE_HEARTBEAT_LEN 8
#define MAVLINK_MSG_ID_MACE_HEARTBEAT_MIN_LEN 8
#define MAVLINK_MSG_ID_12400_LEN 8
#define MAVLINK_MSG_ID_12400_MIN_LEN 8

#define MAVLINK_MSG_ID_MACE_HEARTBEAT_CRC 6
#define MAVLINK_MSG_ID_12400_CRC 6
...
#define MAVLINK_MESSAGE_INFO_MACE_HEARTBEAT { \
    ...
    {  { "vehicle_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mace_heartbeat_t, vehicle_id) }, \
         ...
         { "armed", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mace_heartbeat_t, armed) }, \
         { "inMotion", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mace_heartbeat_t, inMotion) }, \
         { "vehicle_hsm", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_mace_heartbeat_t, vehicle_hsm) }, \
 ...
 * @param armed  Indication of whether or not the vehicle is currently armed. 
 * @param inMotion  Indication of whether or not the vehicle is currently in motion. This would imply flight for aircraft or moving for vehicles. 
...
static inline uint16_t mavlink_msg_mace_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t vehicle_id, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t armed, uint8_t inMotion, uint8_t vehicle_hsm)
{
    ...
    _mav_put_uint8_t(buf, 5, inMotion);
    _mav_put_uint8_t(buf, 6, vehicle_hsm);
...
{
    return mavlink_msg_mace_heartbeat_pack(system_id, component_id, msg, mace_heartbeat->vehicle_id, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->armed, mace_heartbeat->inMotion, mace_heartbeat->vehicle_hsm);
}
...
{
    return mavlink_msg_mace_heartbeat_pack_chan(system_id, component_id, chan, msg, mace_heartbeat->vehicle_id, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->armed, mace_heartbeat->inMotion, mace_heartbeat->vehicle_hsm);
}
...
static inline void mavlink_msg_mace_heartbeat_send(mavlink_channel_t chan, uint8_t vehicle_id, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t armed, uint8_t inMotion, uint8_t vehicle_hsm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_HEARTBEAT_LEN];
    _mav_put_uint8_t(buf, 0, vehicle_id);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_heartbeat_send(chan, mace_heartbeat->vehicle_id, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->armed, mace_heartbeat->inMotion, mace_heartbeat->vehicle_hsm);
#else
 ...
 */
static inline void mavlink_msg_mace_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t vehicle_id, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t armed, uint8_t inMotion, uint8_t vehicle_hsm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field armed from mace_heartbeat message
 *
 * @return  Indication of whether or not the vehicle is currently armed. 
 */
static inline uint8_t mavlink_msg_mace_heartbeat_get_armed(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  4);
}

/**
 * @brief Get field inMotion from mace_heartbeat message
 *
 * @return  Indication of whether or not the vehicle is currently in motion. This would imply flight for aircraft or moving for vehicles. 
 */
static inline uint8_t mavlink_msg_mace_heartbeat_get_inMotion(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mace_heartbeat_decode(const mavlink_message_t* msg, mavlink_mace_heartbeat_t* mace_heartbeat)
{
    ...
    mace_heartbeat->armed = mavlink_msg_mace_heartbeat_get_armed(msg);
    mace_heartbeat->inMotion = mavlink_msg_mace_heartbeat_get_inMotion(msg);
