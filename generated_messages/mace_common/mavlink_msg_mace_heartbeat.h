...
#define MAVLINK_MSG_ID_MACE_HEARTBEAT_LEN 5
#define MAVLINK_MSG_ID_MACE_HEARTBEAT_MIN_LEN 5
#define MAVLINK_MSG_ID_12400_LEN 5
#define MAVLINK_MSG_ID_12400_MIN_LEN 5

#define MAVLINK_MSG_ID_MACE_HEARTBEAT_CRC 179
#define MAVLINK_MSG_ID_12400_CRC 179
...
#define MAVLINK_MESSAGE_INFO_MACE_HEARTBEAT { \
    ...
    "MACE_HEARTBEAT", \
    5, \
    {  { "type", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_mace_heartbeat_t, type) }, \
         { "autopilot", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_mace_heartbeat_t, autopilot) }, \
         { "flight_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_mace_heartbeat_t, flight_mode) }, \
         { "vehicle_hsm", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_mace_heartbeat_t, vehicle_hsm) }, \
         { "mavlink_version", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mace_heartbeat_t, mavlink_version) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MACE_HEARTBEAT { \
...
static inline uint16_t mavlink_msg_mace_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t vehicle_hsm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_HEARTBEAT_LEN];
    _mav_put_uint8_t(buf, 0, type);
    _mav_put_uint8_t(buf, 1, autopilot);
    _mav_put_uint8_t(buf, 2, flight_mode);
    _mav_put_uint8_t(buf, 3, vehicle_hsm);
    _mav_put_uint8_t(buf, 4, 3);
...
{
    return mavlink_msg_mace_heartbeat_pack(system_id, component_id, msg, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->vehicle_hsm);
}
...
{
    return mavlink_msg_mace_heartbeat_pack_chan(system_id, component_id, chan, msg, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->vehicle_hsm);
}
...
static inline void mavlink_msg_mace_heartbeat_send(mavlink_channel_t chan, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t vehicle_hsm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MACE_HEARTBEAT_LEN];
    _mav_put_uint8_t(buf, 0, type);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mace_heartbeat_send(chan, mace_heartbeat->type, mace_heartbeat->autopilot, mace_heartbeat->flight_mode, mace_heartbeat->vehicle_hsm);
#else
 ...
 */
static inline void mavlink_msg_mace_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t vehicle_hsm)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
