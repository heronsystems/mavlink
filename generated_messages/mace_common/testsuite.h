...
static void mavlink_test_mace_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_mace_heartbeat_t packet1, packet2;
        ...
        packet1.inMotion = packet_in.inMotion;
    ...
    mavlink_msg_mace_heartbeat_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_heartbeat_pack(system_id, component_id, &msg , packet1.vehicle_id , packet1.type , packet1.autopilot , packet1.flight_mode , packet1.armed , packet1.inMotion , packet1.vehicle_hsm );
    mavlink_msg_mace_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.vehicle_id , packet1.type , packet1.autopilot , packet1.flight_mode , packet1.armed , packet1.inMotion , packet1.vehicle_hsm );
    mavlink_msg_mace_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mace_heartbeat_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_heartbeat_send(MAVLINK_COMM_1 , packet1.vehicle_id , packet1.type , packet1.autopilot , packet1.flight_mode , packet1.armed , packet1.inMotion , packet1.vehicle_hsm );
    mavlink_msg_mace_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mace_set_vehicle_mode(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MACE_SET_VEHICLE_MODE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_mace_set_vehicle_mode_t packet_in = {
        5,"BCDEFGHIJKLMNOPQRST"
    };
    mavlink_mace_set_vehicle_mode_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.target_system = packet_in.target_system;
        
        mav_array_memcpy(packet1.mode, packet_in.mode, sizeof(char)*20);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MACE_SET_VEHICLE_MODE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MACE_SET_VEHICLE_MODE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_set_vehicle_mode_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mace_set_vehicle_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_set_vehicle_mode_pack(system_id, component_id, &msg , packet1.target_system , packet1.mode );
    mavlink_msg_mace_set_vehicle_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_set_vehicle_mode_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.mode );
    mavlink_msg_mace_set_vehicle_mode_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mace_set_vehicle_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mace_set_vehicle_mode_send(MAVLINK_COMM_1 , packet1.target_system , packet1.mode );
    mavlink_msg_mace_set_vehicle_mode_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_mace_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_mace_set_vehicle_mode(system_id, component_id, last_msg);
