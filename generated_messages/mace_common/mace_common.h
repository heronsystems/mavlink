...
#define MAVLINK_MESSAGE_CRCS {{12400, 79, 9, 9, 3, 6, 7}}
#endif
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_COMMAND_SHORT}
# define MAVLINK_MESSAGE_NAMES {{ "COMMAND_SHORT", 12400 }}
